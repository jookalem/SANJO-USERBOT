...
async def typewriter(typew):
    ...
    sleep(2)
    await typew.edit("**Alay banget lu goblok**")
    sleep(2)
    await typew.edit("**Baru pasang userbot ya?**")
    sleep(2)
    await typew.edit("**Pantesan alay lo anjeng**")
    sleep(2)
    await typew.edit("**Kalo mau coba coba command di gc pribadi aja bego**")
    sleep(2)
    await typew.edit("**Jangan di publik dek, najis gua bego liatnya**")
    sleep(2)
    await typew.edit("***Najis bocah kampung yang tinggal di lampung*")
    sleep(2)
    await typew.edit("**pantes noraknya ga ketulung**")
