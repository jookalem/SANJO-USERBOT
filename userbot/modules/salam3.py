...
async def typewriter(typew):
    ...
    sleep(1.5)
    await typew.edit("**PETINGGI TELE**")
    sleep(1.5)
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("**OI PETINGGI TELE**")
    sleep(2)
    ...
    sleep(2)
    await typew.edit("**KERJAAN CUMA MERUSAK CEWE NGENTOT**")
    sleep(4)
    await typew.edit("**YAELAH BRO MENTAL LO CUMA DI SOSMED APA GIMANE?**")
    sleep(2)
    await typew.edit(
        "**PERASAAN DULU TELEGRAM GAADA DEH BOCAH BOCAH SOK JAGO KEK GINI ANJING**"
    )
    sleep(2)
    await typew.edit("**GILIRAN DI MINTA VNV MALAH KABUR,ADU PUNYA MASALAH MALAH KABUR**")
    sleep(4)
    await typew.edit("**MENDEUK MULU KEK AYAM LU**")
    sleep(2)
    await typew.edit("**BUSET DAH BANG**")
    sleep(2)
    await typew.edit("**UDAH SEJAGO APESI LU RIYAN**")
    sleep(3)
    await typew.edit("**ORANG TUA LO NOH ADA YANG NAGIH UTANG UDA LO BELA BELOM?**")
    sleep(4)
    await typew.edit("**RELA NGUTANG DEMI NGIDUPIN LU**")
    sleep(2)
    await typew.edit("**EH ANAKNYA MALAH NGERUSAK CW **")
    sleep(3)
...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("**MUKA MASIH KAYA TUKANG KORAN AJA**")
    sleep(1)
