...
async def typewriter(typew):
    ...
    await typew.edit("**Skyzi Kuli Bangunan✅**")
    sleep(3)
    ...
    sleep(3)
    await typew.edit("**Vxin China Wibu☑️**")
    await typew.edit("**Vxin China Wibu✅**")
    sleep(3)
    await typew.edit("**Cumi Cantik Banget☑️**")
    await typew.edit("**Cumi Cantik Banget✅**")
    sleep(3)
    await typew.edit("**Barra Kang Depo☑️**")
    await typew.edit("**Barra Kang Depo✅**")
    sleep(3)
    await typew.edit("**CUMAN SANJO PALING TAMPAN, DAN TIDAK SOMBONG!..**")
...
async def typewriter(typew):
    ...
    sleep(3)
    await typew.edit("`Bocah goblok yang gobloknya seperti rucika mengalir sampai jauh, Lu lebih goblok lagi goblok gobloknya keturunan sampai lu lahir!`")
