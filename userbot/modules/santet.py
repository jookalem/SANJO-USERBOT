...
async def typewriter(typew):
    ...
    await typew.edit(f"**{ALIVE_NAME} Pengen Nyantet Si Kontol Ini!**")
    sleep(2)
    await typew.edit("__Mencari Nama Si Kontol...__")
    sleep(2)
    await typew.edit("__Santet Online Segera Dilakukan,Mampus Lu Jelek!!__")
    sleep(2)
    await typew.edit("0%")
    number = 1
