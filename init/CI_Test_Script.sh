...
tg_sendinfo "<code>I am gonna merge staging into DIOR-UBOT</code>"
cd
...
git push --force origin staging:DIOR-UBOT
tg_sendinfo "<code>I have merged all commits from staging into DIOR-UBOT</code>"
